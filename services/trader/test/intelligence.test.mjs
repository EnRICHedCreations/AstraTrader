...
test("mint programs are explicit and unknown programs fail closed", () => {
  assert.deepEqual(mintProgram(TOKEN), {
    id: TOKEN,
    name: "spl-token",
    recognized: true,
    executionSupported: true,
    requiresExtensionReview: false,
  });
  assert.deepEqual(mintProgram("TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb"), {
    id: "TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb",
    name: "spl-token-2022",
    recognized: true,
    executionSupported: true,
    requiresExtensionReview: true,
  });
  assert.deepEqual(mintProgram("not-a-token-program"), {
    id: "not-a-token-program",
    name: "unknown",
    recognized: false,
